...
```{r extmap, fig.align = 'left', out.width = "40%", fig.cap = "Diferencia entre la maxima extensión de GLAD y la de SMBYC"}
...
```{r matcont, echo=FALSE, eval= TRUE, include=TRUE, warning=FALSE}
#require(knitr)
#require(kableExtra)
load('/Users/sputnik/Documents/biomas_iavh/final_march/ag_id_ha_85.RData')
